...
<?php $title = 'ACCREDITATION REQUIREMENT' ?>
                            ...
                            <table class="table table-invoice">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        //echo $item;
                                        $view_query = mysqli_query($con,"SELECT OrgAccrDetail_DESC AS DESCR FROM r_org_accreditation_details WHERE OrgAccrDetail_CODE IN ('1'".$item.")");
                                        $i = 1;
