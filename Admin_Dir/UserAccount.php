...
?>
        ...
        <link rel="stylesheet" type="text/css" href="../js/select2/select2.css" /> </head>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    <div class="clearfix">
                                        <div class="btn-group">
                                            <button id="editable-sample_new" class="btn btn-success add" data-toggle="modal" href="#Add"> Add <i class="fa fa-plus"></i> </button>
                                        </div>
            ...
            <div class="modal-content">
                <form method="post" id="form-data" action="" enctype="multipart/form-data">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Add User Account</h4> </div>
                                    ...
                                    <div class="col-lg-12 ">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <div> <span class="btn btn-white btn-file">
                                                ...
                                                <input type="file" name="file" id="file" class="default" /> </span> <a href="#" class="btn btn-danger btn-sm fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash"></i>Remove</a> </div>
                                        </div>
                                    </div>
                                </div>
                                    <div class="col-lg-6">
                                        <div class="col-lg-12"> User Name
                                            <input type="text" class="form-control" placeholder="ex. Juan Dela Cruz" id="txtusername"> </div>
                                        <div class="col-lg-12"> Password
                                            <input type="password" class="form-control" placeholder="ex. Password" id="txtpassword"> </div>
                                        <div class="col-lg-12" style="padding-top:10px"> Role
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="Edit" class="modal fade">
        <div class="modal-dialog" style="width:700px">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Edit User Account</h4> </div>
                <div class="modal-body">
                    <form method="post" id="updform-data" action="" enctype="multipart/form-data">
                        <div class="row" style="padding-left:15px;padding-top:10px">
                            <div class="col-lg-12 ">
                                <div class="col-lg-6">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div> <span class="btn btn-white btn-file">
                                                   ...
                                                   <span class="fileupload-new"><i class="fa fa-paper-clip" ></i> Select image</span> <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                            <input type="file" name="file" class="default" /> </span> <a href="#" class="btn btn-danger btn-sm fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash"></i>Remove</a> </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="col-lg-12"> User Name
                                        <input type="text" class="form-control" placeholder="ex. Juan Dela Cruz" id="updtxtusername"> </div>
                                    <div class="col-lg-12" style="padding-top:10px"> Password
                                        <input type="password" class="form-control" placeholder="ex. Password" id="updtxtpassword"> </div>
                                    <div class="col-lg-12" style="padding-top:10px"> Role
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-success " id="updsubmit-data" type="submit">Save</button>
                        </div>
                    </form>
                </div>
            </div>
