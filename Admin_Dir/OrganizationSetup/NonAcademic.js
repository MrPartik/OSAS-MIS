                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                type: 'post',
                                url: 'OrganizationSetup/NonAcademic/Add-ajax.php',
                                data: {
                                    _code: txtcode,
                                    _name: txtname,
                                    _desc: txtdesc
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                type: 'post',
                                url: 'OrganizationSetup/NonAcademic/Delete-ajax.php',
                                data: {
                                    _code: getval
                                },
                                success: function (response) {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                type: 'post',
                                url: 'OrganizationSetup/NonAcademic/Retrieve-ajax.php',
                                data: {
                                    _code: getval
                                },
                                success: function (response) {
            ...
            $('#editable-sample a.edit').live('click', function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    if (jqInputs[1].value.length < 100 && jqInputs[1].value.length > 5 && jqInputs[2].value.length < 100 && jqInputs[2].value.length > 5) {
                        $.ajax({
                            type: 'post',
                            url: 'OrganizationSetup/NonAcademic/Update-ajax.php',
                            data: {
                        ...
                        swal("Error", "Please enter a valid  description it must greater than 5 characters", "error");
