<?php
    ...
    $query = mysqli_query($con,"UPDATE t_assign_org_members SET AssOrgMem_DISPLAY_STAT = 'Inactive' WHERE AssOrgMem_STUD_NO = '$studno' AND AssOrgMem_COMPL_ORG_CODE = '$appcode' ");
