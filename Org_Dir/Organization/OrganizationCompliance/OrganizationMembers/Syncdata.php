...
//    $query = mysqli_query($connection,"UPDATE t_assign_org_members SET AssOrgMem_DISPLAY_STAT = 'Inactive' WHERE AssOrgMem_COMPL_ORG_CODE = '$compcode' ");
    ...
    while($row = mysqli_fetch_assoc($view_query))
    {
        ...
        $getcount = mysqli_query($con," SELECT COUNT(*) AS COU FROM t_assign_org_members WHERE AssOrgMem_STUD_NO = '$no' AND AssOrgMem_COMPL_ORG_CODE = '$code' ");
...
//            $query = mysqli_query($connection,"UPDATE t_assign_org_members SET AssOrgMem_COMPL_ORG_CODE = '$code' WHERE AssOrgMem_STUD_NO = '$no' ");
            ...
            $query = mysqli_query($con,"INSERT INTO t_assign_org_members (AssOrgMem_STUD_NO,AssOrgMem_COMPL_ORG_CODE) VALUES ('$no','$code') ");
