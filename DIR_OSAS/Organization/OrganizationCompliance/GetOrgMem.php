<?php
    ...
    $query = "SELECT CONCAT(Stud_LNAME,', ',Stud_FNAME ,' ', IFNULL(Stud_MNAME,''))  AS NAME , Stud_NO , CONCAT(Stud_COURSE,' ',Stud_YEAR_LEVEL,' - ',Stud_SECTION) AS CAS FROM t_assign_org_members
        ...
        WHERE AssOrgMem_DISPLAY_STAT = 'Active' AND AssOrgMem_COMPL_ORG_CODE = (SELECT OrgForCompliance_OrgApplProfile_APPL_CODE FROM t_org_for_compliance WHERE OrgForCompliance_ORG_CODE = '$compcode') ";
