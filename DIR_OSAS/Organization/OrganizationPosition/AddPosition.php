<?php
	...
	if(isset($_POST['_code']))
	{
        ...
        echo "INSERT INTO r_org_officer_position_details (OrgOffiPosDetails_ORG_CODE,OrgOffiPosDetails_NAME,OrgOffiPosDetails_DESC,OrgOffiPosDetails_NumOfOcc)  VALUES ('$code','$pos','$desc','$occ')";
