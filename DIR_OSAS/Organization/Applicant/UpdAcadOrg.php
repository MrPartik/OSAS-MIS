<?php
	...
	include('../../../config/connection.php');
        ...
        {   
            ...
            $view_query = mysqli_query($con,"SELECT COUNT(*) AS COU FROM `t_assign_org_academic_course` WHERE AssOrgAcademic_ORG_CODE = '$code' AND AssOrgAcademic_COURSE_CODE = '$coucoude'  ");
