<?php
    ...
    if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest')
	{
        ...
        if($role == 'OSAS HEAD'){
            ...
            if($status == 'Rejected'){
               $evactive = '<li><a href="javascript:;"> <i class="fa fa-exclamation"></i> Event Status <span class="label label-success label-success pull-right r-activity" id="">Rejected</span></a></li>';
            }
            else if($evstat == 'On Going'){
               $evactive = '<li><a href="javascript:;"> <i class="fa fa-exclamation"></i> Event Status <span class="label label-success label-success pull-right r-activity" id="">On Going</span></a></li>';

            }
            else if($evstat == 'Sa future'){
               $evactive = '<li><a href="javascript:;"> <i class="fa fa-exclamation"></i> Event Status <span class="label label-success label-success pull-right r-activity" id="">Incoming</span></a></li>';

            }
            else{
               $evactive = '<li><a href="javascript:;"> <i class="fa fa-exclamation"></i> Event Status <span class="label label-success label-success pull-right r-activity" id="">Done</span></a></li>';
            }         
            ...
            if($status == 'Pending'){
                $container = $container . $evactive .'<li><a href="javascript:;"><i class="fa fa-info-circle"></i>Approval Status<span class="badge label-primary pull-right r-activity" id="lblstat">'.$status.'</span> </a></li>
                            <li><a href="javascript:;"> <i class="fa fa-bullseye"></i> Event Name <span class="badge label-label pull-right r-activity" id="lblsendby">'.$eventname.'</span></a></li>
                            <li><a href="javascript:;"> <i class="fa fa-comments-o"></i> Event Description <span class="badge label-label pull-right r-activity"  id="lblamount">'.$eventdesc.'</span></a></li>
                            <li><a href="javascript:;"> <i class="fa fa-flag"></i> Date <span class="badge label-label pull-right r-activity"  id="lbldesc">'.$date.'</span></a></li>
                            <li>
                                <div class="row">
                ...
                $container = $container . $evactive .'<li><a href="javascript:;"><i class="fa fa-info-circle"></i>Approval Status<span class="badge label-danger pull-right r-activity" id="lblstat">'.$status.'</span> </a></li>
                <li><a href="javascript:;"> <i class="fa fa-mail-forward"></i> Reviewed By <span class="badge label-label pull-right r-activity" id="lblsendby">'.$rev.'</span></a></li>
                <li><a href="javascript:;"> <i class="fa fa-bullseye"></i> Event Name <span class="badge label-label pull-right r-activity" id="lblsendby">'.$eventname.'</span></a></li>
                <li><a href="javascript:;"> <i class="fa fa-comments-o"></i> Event Description <span class="badge label-label pull-right r-activity"  id="lblamount">'.$eventdesc.'</span></a></li>
                <li><a href="javascript:;"> <i class="fa fa-flag"></i> Date <span class="badge label-label pull-right r-activity"  id="lbldesc">'.$date.'</span></a></li>
