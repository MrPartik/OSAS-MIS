...
-->
                                                <? $profQuery  =  mysqli_query($con,"SELECT Stud_ID as ID ,Stud_NO ,Stud_LNAME,Stud_FNAME,Stud_MNAME,CONCAT(Stud_LNAME,', ',Stud_FNAME,' ',COALESCE(Stud_MNAME,'')) as FullName ,Stud_COURSE,CONCAT(Stud_COURSE,' ',Stud_YEAR_LEVEL,'-',Stud_SECTION) as Course ,Stud_EMAIL , Stud_SECTION,Stud_CONTACT_NO ,Stud_GENDER ,Stud_BIRHT_DATE ,Stud_BIRTH_PLACE ,Stud_STATUS ,Stud_ADDRESS  FROM r_stud_profile R_SP
