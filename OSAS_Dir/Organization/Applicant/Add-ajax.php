...
include('../../../config/connection.php');     
	...
	if(isset($_POST['_name']))
	{
        ...
        $acr = strtoupper($acr);
        $query = mysqli_query($con,"INSERT INTO r_org_applicant_profile (OrgAppProfile_APPL_CODE,OrgAppProfile_NAME,OrgAppProfile_DESCRIPTION) VALUES (CONCAT('$acr',(SELECT YEAR(CURRENT_TIMESTAMP))),'$name','$desc')");
