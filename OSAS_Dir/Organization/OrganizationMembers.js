        ...
        init: function () {
            ...
            $('#btnaddstud').click(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        var aiNew = oTable.fnAddData([data.snum, data.sname, data.cas, '<center><a class="btn btn-danger delete tooltips" data-toggle="tooltip" href="javascript:;"><i class="fa fa-trash-o" ></i></a></center>']);
