<?php
	...
	if(isset($_POST['_name']) && isset($_POST['_desc']) )
	{
		...
		$query = mysqli_query($connection,"INSERT INTO `r_clearance_signatories` (ClearSignatories_CODE,ClearSignatories_NAME,ClearSignatories_DESC) VALUES ('$code','$name','$desc')");
