...
$currentPage ='OSAS_ClearanceSignatory'; include('../../../config/connection.php');
?>
...
<body>
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
										...
										$view_query = mysqli_query($connection,"select * from `r_clearance_signatories` where ClearSignatories_DISPLAY_STAT = 'Active'");
    ...
    <script src="ClearanceSignatory.js"></script>
    ...
    <script>
        $(document).ready(function() {
            $('.add').click(function() {
                $.ajax({
                    type: "GET",
                    url: 'ClearanceSignatory/GetLatest-Code.php',
