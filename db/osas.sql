...
CREATE TABLE `r_batch_details`  (
  ...
  `Batch_CODE` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `r_users`  (
  ...
  `Users_ROLES` enum('Administrator','OSAS HEAD','Organization','Student') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
