...
<?php $title = 'ORGANIZATION CATEGORY' ?>
                            ...
                            <table class="table table-invoice">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        //echo $item;
                                        $view_query = mysqli_query($con,"SELECT FinAssiTitle_NAME AS NAME,FinAssiTitle_DESC AS DESCR FROM r_financial_assistance_title WHERE FinAssiTitle_CODE IN ('1'".$item.")");
                                        $i = 1;
