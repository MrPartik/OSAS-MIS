                            ...
                            <table class="table table-invoice">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        //echo $item;
                                        $view_query = mysqli_query($con,"SELECT ClearSignatories_NAME AS NAME ,ClearSignatories_DESC AS DESCR FROM r_clearance_signatories WHERE ClearSignatories_CODE IN ('1'".$item.")");
                                        $i = 1;
