    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li> <a <?php if( $currentPage==='Admin_Dashboard' ) {echo 'class="active"';} ?> href="Dashboard.php">
                        <i class ="fa fa-dashboard" ></i>
                        <span>Dashboard</span>
                    </a> </li>
                <li class="sub-menu"> <a <?php if( $currentPage==='Admin_BYear' || $currentPage==='Admin_Title' || $currentPage==='Admin_Semester' ) { echo 'class="active"';} ?> href="javascript:;">
                ...
                <li class="sub-menu"> <a <?php if( $currentPage==='Admin_AccrReq' || $currentPage==='Admin_Course' || $currentPage==='Admin_OfficerPos' || $currentPage==='Admin_OrgCat' || $currentPage==='Admin_NonAcad' ) { echo 'class="active"';} ?> href="javascript:;">
                    ...
                    <ul class="sub">
                        ...
                        <li <?php if( $currentPage==='Admin_OrgCat' ) { echo 'class="active"';} ?>><a href="AcademicCategory.php">Organization Category</a></li>
                        <li <?php if( $currentPage==='Admin_NonAcad' ) { echo 'class="active"';} ?>><a href="NonAcademicCategory.php">Non Academic Category </a></li>
                    </ul>
                </li>
                <li class="sub-menu"> <a <?php if( $currentPage==='Admin_ClearanceSig' || $currentPage==='Admin_Designated' || $currentPage==='Admin_SancDet' ) { echo 'class="active"';} ?> href="javascript:;">
                ...
                <li class="sub-menu"> <a <?php if( $currentPage==='Admin_ActiveYear' || $currentPage==='Admin_ActiveSem' || $currentPage==='Admin_Account' ) { echo 'class="active"';} ?> href="javascript:;">
