<?php
    ...
    if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest')
	{
        ...
        if($role == 'OSAS HEAD'){
            $query = mysqli_prepare($con, " UPDATE r_org_event_management SET OrgEvent_STATUS = 'Rejected',OrgEvent_DATE_MOD=CURRENT_TIMESTAMP,OrgEvent_ReviewdBy = '$id' WHERE OrgEvent_Code = ? ");
